...
const CreateSheet = ({ showModal, onClose, atLast, wbId }) => {
    ...
    const submit = async () => {
        ...
        try {
            ...
            const response = await axios.post("http://localhost:8000/api/sheets/create-sheet", data, config);
            ...
            <div className="fixed inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 z-50">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden w-96">
                    <div className="flex items-center justify-between p-4 border-b">
                        <h3 className="text-xl font-semibold text-gray-900">Create Sheet</h3>
                        <button
                            type="button"
